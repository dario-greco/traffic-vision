...
class DetSolver(BaseSolver):
    def fit(self):
        ...
        # Early stopping: read patience from config (0 or None = disabled)
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            if patience > 0:
                ...
                if dist_utils.is_main_process():
                    print(
                        f"Early stopping: {epochs_no_improve}/{patience} epochs without improvement."
                    )
                ...
                if epochs_no_improve >= patience:
                    if dist_utils.is_main_process():
                        print(
                            ...
                            f"Best AP was {top1:.4f} at epoch {best_stat.get('epoch', -1)}."
                        )
                    break
            # ─────────────────────────────────────────────────────────────────
